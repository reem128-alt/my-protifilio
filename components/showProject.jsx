...
const images = [
  {
    id: 1,
    src: "/music.jpg",
    href: "https://music-app-reem-hasans-projects-9ab23a8b.vercel.app/",
    url: "https://github.com/Reem-del/musicApp",
    active: "one",
  },
  {
    id: 2,
    src: "/quiz.jpg",
    href: "https://quiz-eta-five.vercel.app/",
    active: "two",
    url: "https://github.com/Reem-del/Quiz",
  },
  {
    id: 3,
    src: "/ecommerce.jpg",
    href: "https://shop-reem-del-reem-hasans-projects-9ab23a8b.vercel.app/",
    active: "three",
    url: "https://github.com/Reem-del/e-commerce",
  },
  {
    id: 4,
    src: "/blog.jpg",
    href: "https://blog-seven-sigma-81.vercel.app/",
    active: "four",
  ...
  },
  {
    id: 5,
    src: "/health.jpg",
    href: "https://health-care-flax-rho.vercel.app/",
    active: "six",
...
export default function ShowProject() {
  ...
  return (
    <div className="h-[400px] w-full text-slate-200  hover:text-yellow-200 max-[430px]:h-[700px]">
      ...
      <ul
        ref={ref}
        className="flex flex-wrap mx-3 gap-4 justify-center items-center w-full h-64 max-[350px]:gap-6 "
      >
        {images.map((img, index) => (
          ...
          >
            <div
              key={img.id}
              className="relative w-[200px] h-full shadow-sm shadow-gray-300 max-[430px]:h-32"
