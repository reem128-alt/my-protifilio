...
{id:4,src:'/blog.jpg',href:'https:https://blog-beta-seven-98.vercel.app/en/signin',active:'four',url:'https://github.com/reem128-alt/blog'},
{id:5,src:'/movie.jpg',href:'https://movie-dash-front.vercel.app/',active:'five',url:'https://github.com/reem128-alt/movie-dash-front'},
{id:6,src:'/health.jpg',href:'https://health-care-qw9j.vercel.app/',active:'six',url:'https://github.com/reem128-alt/health-care'},
  ...
  return (
     <div className='min-h-[450px] w-full text-slate-200 mt-12 hover:text-yellow-200 max-[430px]:min-h-[700px]'>
      ...
      <h3 className='text-center font-bold text-2xl p-3 bg-clip-text text-transparent bg-gradient-to-r from-yellow-500 to-blue-300 mb-4'>
              <span className='underline underline-offset-4 text-yellow-300'>show </span> PROJECTS
            </h3>
            <FaArrowRight size={20} className='mt-4 hover:animate-bounce'/>

        </div>
        <ul ref={ref} className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 justify-items-center mx-auto max-w-7xl px-4 mb-12'>
